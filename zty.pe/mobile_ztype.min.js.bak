...
ig.module("game.menus.base")
  ...
  .defines(function () {
    ...
    Menu = ig.Class.extend({
      clearColor: null,
      name: null,
      font: new ig.Font("mobile/media/fonts/avenir-36-white.png"),
      fontSelected: new ig.Font("mobile/media/fonts/avenir-36-orange.png"),
      current: 0,
      itemClasses: [],
      items: [],
      scale: 1,
...
ig.module("game.menus.about")
  ...
  .defines(function () {
    ...
    MenuAbout = Menu.extend({
      background: new ig.Image("mobile/media/background/stars.jpg"),
      credits: new ig.Image("mobile/media/title/credits.png"),
      scale: 0.75,
      scroll: 0,
...
ig.module("game.menus.interstitial")
  ...
  .defines(function () {
    ...
    MenuInterstitial = Menu.extend({
      ...
      scale: 0.75,
      banner: new ig.Image("mobile/media/nfn-phoboslab-works.png"),
      init: function () {
        this.parent();
...
ig.module("game.menus.game-over")
  ...
  .defines(function () {
    ...
    MenuGameOver = Menu.extend({
      ...
      scale: 0.75,
      personalBestBadge: new ig.Image("mobile/media/ui/personal-best-badge.png"),
      fontTitle: new ig.Font("mobile/media/fonts/avenir-36-blue.png"),
      separatorBar: new ig.Image("mobile/media/ui/bar-blue.png"),
      init: function () {
        if (ig.doc) {
...
ig.module("game.menus.title")
  ...
  .defines(function () {
    ...
    MenuTitle = Menu.extend({
      ...
      scroll: 0,
      background: new ig.Image("mobile/media/background/stars.jpg"),
      ztype: new ig.Image("mobile/media/title/ztype.png"),
      phoboslab: new ig.Image("mobile/media/title/phoboslab.png"),
      ship: new ig.Image("mobile/media/title/ship.png"),
      exhaust: new ig.Image("mobile/media/title/exhaust.png"),
      infoIcon: new ig.Image("mobile/media/ui/information.png"),
      glitchStripe: new ig.Image("mobile/media/title/glitch-stripe.png"),
      glitchCode: new ig.Image("mobile/media/title/glitch-code.png"),
      glitchJPEG: new ig.Image("mobile/media/title/glitch-jpeg.png"),
      glitchGraph: new ig.Image("mobile/media/title/glitch-graph.png"),
      glitchLog: new ig.Image("mobile/media/title/glitch-log.png"),
...
ig.module("game.entities.explosion")
  ...
  .defines(function () {
    window.EntityExplosionParticle = EntityParticle.extend({
      ...
      fadetime: 0.5,
      vel: { x: 60, y: 60 },
      animSheet: new ig.AnimationSheet("mobile/media/sprites/explosion.png", 32, 32),
      init: function (x, y, settings) {
    ...
    window.EntityExplosionSpark = EntityParticle.extend({
      ...
      fadetime: 0.5,
      vel: { x: 60, y: 60 },
      animSheet: new ig.AnimationSheet("mobile/media/sprites/spark.png", 48, 48),
      init: function (x, y, settings) {
    ...
    window.EntityExplosionHuge = ig.Entity.extend({
      ...
      fadetime: 1,
      alpha: 0,
      img: new ig.Image("mobile/media/sprites/explosion-huge.jpg", 512, 512),
      init: function (x, y, settings) {
        this.parent(x, y, settings);
        this.idleTimer = new ig.Timer();
      },
    ...
    window.EntityExplosionHugeGlitch = EntityExplosionHuge.extend({
      img: new ig.Image("mobile/media/sprites/explosion-huge-glitch.jpg", 512, 512),
      glitchJPEG: new ig.Image("mobile/media/title/glitch-jpeg.png"),
      glitchStripe: new ig.Image("mobile/media/title/glitch-stripe.png"),
      draw: function () {
        this.parent();
...
ig.module("game.entities.enemy")
  ...
  .defines(function () {
    EntityEnemy = ig.Entity.extend({
      ...
      currentLetter: 0,
      targeted: false,
      font: new ig.FontAvenirNext("mobile/media/fonts/avenir-22-white-v2.png"),
      fontActive: new ig.FontAvenirNext("mobile/media/fonts/avenir-22-orange-v2.png"),
      speed: 10,
      ...
      numKillParticles: 20,
      numHitParticles: 5,
      soundHit: new ig.Sound("mobile/media/sounds/hit.ogg"),
      soundTarget: new ig.Sound("mobile/media/sounds/target.ogg"),
      reticleTimer: null,
      reticle: new ig.Image("mobile/media/ui/reticle.png"),
...
ig.module("game.entities.enemy-missle")
  ...
  .defines(function () {
    EntityEnemyMissle = EntityEnemy.extend({
      size: { x: 8, y: 15 },
      offset: { x: 6, y: 7 },
      animSheet: new ig.AnimationSheet("mobile/media/sprites/missle.png", 20, 26),
      explosionSound: new ig.Sound("mobile/media/sounds/explosion-small.ogg"),
      health: 4,
      speed: 35,
      targetTimer: null,
...
ig.module("game.entities.enemy-mine")
  ...
  .defines(function () {
    EntityEnemyMine = EntityEnemy.extend({
      size: { x: 12, y: 12 },
      offset: { x: 10, y: 10 },
      animSheet: new ig.AnimationSheet("mobile/media/sprites/mine.png", 32, 32),
      explosionSound: new ig.Sound("mobile/media/sounds/explosion.ogg"),
      speed: 30,
      health: 6,
...
ig.module("game.entities.enemy-destroyer")
  ...
  .defines(function () {
    EntityEnemyDestroyer = EntityEnemy.extend({
      size: { x: 24, y: 34 },
      offset: { x: 10, y: 8 },
      animSheet: new ig.AnimationSheet("mobile/media/sprites/destroyer.png", 43, 58),
      explosionSound: new ig.Sound("mobile/media/sounds/explosion-large.ogg"),
      health: 8,
      speed: 20,
      shootTimer: null,
...
ig.module("game.entities.enemy-oppressor")
  ...
  .defines(function () {
    EntityEnemyOppressor = EntityEnemy.extend({
      size: { x: 36, y: 58 },
      offset: { x: 16, y: 10 },
      animSheet: new ig.AnimationSheet("mobile/media/sprites/oppressor.png", 68, 88),
      explosionSound: new ig.Sound("mobile/media/sounds/explosion-large.ogg"),
      health: 10,
      speed: 15,
      shootTimer: null,
    ...
    EntityEnemyBullet = EntityEnemy.extend({
      size: { x: 2, y: 2 },
      offset: { x: 8, y: 11 },
      animSheet: new ig.AnimationSheet("mobile/media/sprites/bullet.png", 20, 24),
      health: 1,
      speed: 50,
...
ig.module("game.entities.emp")
  ...
  .defines(function () {
    ...
    window.EntityEMP = ig.Entity.extend({
      ...
      img: new ig.Image("mobile/media/sprites/emp.png"),
      sound: new ig.Sound("mobile/media/sounds/emp.ogg", false),
      init: function (x, y, settings) {
        this.parent(x, y, settings);
        this.idleTimer = new ig.Timer();
        this.sound.play();
...
ig.module("game.entities.player")
  ...
  .defines(function () {
    EntityPlayer = ig.Entity.extend({
      animSheet: new ig.AnimationSheet("mobile/media/sprites/ship.png", 24, 24),
      targetAngle: 0,
      size: { x: 8, y: 8 },
      offset: { x: 8, y: 8 },
      angle: 0,
      targetAngle: 0,
      soundShoot: new ig.Sound("mobile/media/sounds/plasma.ogg"),
      soundMiss: new ig.Sound("mobile/media/sounds/click.ogg"),
      soundExplode: new ig.Sound("mobile/media/sounds/explosion-player.ogg"),
    ...
    EntityPlasma = ig.Entity.extend({
      ...
      animSheet: new ig.AnimationSheet("mobile/media/sprites/plasma.png", 96, 96),
      size: { x: 4, y: 4 },
      offset: { x: 46, y: 46 },
      distance: 100000,
      init: function (x, y, settings) {
...
ig.module("game.keyboard")
  ...
  .defines(function () {
    ig.Keyboard = ig.Class.extend({
      background: new ig.Image("mobile/media/ui/keyboard-background.png"),
      keyboard: null,
      empButton: new ig.Image("mobile/media/ui/emp-buttons.png"),
      pauseButton: new ig.Image("mobile/media/ui/pause.png"),
      font: new ig.Font("mobile/media/fonts/avenir-36-blue.png"),
      hoverImages: {
        leftEdge: new ig.Image("mobile/media/ui/key-edge-left.png"),
        rightEdge: new ig.Image("mobile/media/ui/key-edge-right.png"),
        normal: new ig.Image("mobile/media/ui/key.png"),
      },
      multiBar: new ig.Image("mobile/media/ui/bar-blue.png"),
      multiIndicator: new ig.Image("mobile/media/ui/multi-indicator.png"),
      multiSounds: {
        2: new ig.Sound("mobile/media/sounds/multi-2.ogg"),
        3: new ig.Sound("mobile/media/sounds/multi-3.ogg"),
      },
      width: 0,
      height: 0,
      hoverKey: null,
...
ig.module("game.main")
  ...
  .defines(function () {
    ...
    ZType = ig.Game.extend({
      font: new ig.Font("mobile/media/fonts/avenir-18-white.png"),
      fontTitle: new ig.Font("mobile/media/fonts/avenir-36-blue.png"),
      separatorBar: new ig.Image("mobile/media/ui/bar-blue.png"),
      idleTimer: null,
      spawnTimer: null,
      ...
      yScroll: 0,
      yScroll2: 0,
      gradient: new ig.Image("mobile/media/background/gradient.png"),
      stars: new ig.Image("mobile/media/background/stars.jpg"),
      grid: new ig.Image("mobile/media/background/grid.png"),
      music1: new ig.Sound("mobile/media/music/endure.ogg", false),
      music2: new ig.Sound("mobile/media/music/orientation.ogg", false),
      cancelSound: new ig.Sound("mobile/media/sounds/cancel.ogg"),
      spawnSound: new ig.Sound("mobile/media/sounds/spawn.ogg"),
      menu: null,
      mode: 0,
      score: 0,
      streak: 0,
