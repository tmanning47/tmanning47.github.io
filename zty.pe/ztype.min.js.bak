...
// Remove pre-defined width and height
// Let the canvas size be determined dynamically
// var width = 480;
// var height = 720;

if (ig.ua.mobile) {
  // Handle mobile specific logic (optional)
  ...
  function resizeCanvas() {
    ...
    // Update game system size if available (optional)
    if (ig.game && ig.system) {
      ig.system.resize(canvas.width, canvas.height);
    }
  }
  
  window.addEventListener("resize", resizeCanvas);
  resizeCanvas(); // Call resize function initially
}
