...
ig.module("game.menus.about")
  ...
  .defines(function () {
    ...
    MenuAbout = Menu.extend({
      background: new ig.Image("media/background/mobile_stars.jpg"),
...
ig.module("game.menus.title")
  ...
  .defines(function () {
    ...
    MenuTitle = Menu.extend({
      ...
      ship: new ig.Image("media/title/mobile_ship.png"),
...
ig.module("game.entities.enemy-oppressor")
  ...
  .defines(function () {
    EntityEnemyOppressor = EntityEnemy.extend({
      size: { x: 36, y: 58 },
      offset: { x: 16, y: 10 },
      animSheet: new ig.AnimationSheet("media/sprites/mobile_oppressor.png", 68, 88),
      explosionSound: new ig.Sound("media/sounds/explosion-large.ogg"),
      health: 10,
      speed: 15,
      shootTimer: null,
...
ig.module("game.entities.player")
  ...
  .defines(function () {
    EntityPlayer = ig.Entity.extend({
      animSheet: new ig.AnimationSheet("media/sprites/mobile_ship.png", 24, 24),
      targetAngle: 0,
      size: { x: 8, y: 8 },
      offset: { x: 8, y: 8 },
      angle: 0,
...
ig.module("game.main")
  ...
  .defines(function () {
    ...
    ZType = ig.Game.extend({
      ...
      stars: new ig.Image("media/background/mobile_stars.jpg"),
