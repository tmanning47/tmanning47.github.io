...
ig.module("game.menus.settings", "game.keyboard")
  ...
  .defines(function () {
    MenuItemSoundVolume = MenuItem.extend({
      ...
      click: function () {
        if (ig.input.mouse.x > 1280) { //settings menu centering
          this.right();
        } else {
          this.left();
        }
...
ig.module("game.entities.enemy-oppressor")
  ...
  .defines(function () {
    EntityEnemyOppressor = EntityEnemy.extend({
      size: { x: 54, y: 87 },
      offset: { x: 16, y: 10 },
      animSheet: new ig.AnimationSheet("media/sprites/oppressor.png", 102,132),
      explosionSound: new ig.Sound("media/sounds/explosion-large.ogg"),
      health: 10,
      speed: 15,
      shootTimer: null,
...
ig.module("game.entities.player")
  ...
  .defines(function () {
    EntityPlayer = ig.Entity.extend({
      animSheet: new ig.AnimationSheet("media/sprites/ship.png", 36, 36),
      targetAngle: 0,
      size: { x: 12, y: 12 },
      offset: { x: 12, y: 12 },
      angle: 0,
...
ig.module("game.main")
  ...
  .defines(function () {
      ...
      update: function () {
        ...
        if (this.mode === ZType.MODE.GAME) {
          ...
          if (
            ...
            ig.input.mouse.x < 250 && //settings pause menu button positioning
            ig.input.mouse.y < 250
          ) {
            this.menu = new MenuSettings();
          }
    ...
    var canvas = ig.$("#ztype-game-canvas") || ig.$("#canvas");
		var width = 2560; //game resolution
		var height = 1440;
    if (ig.ua.mobile) {
