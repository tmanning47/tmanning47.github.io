...
ig.module("game.menus.about")
  ...
  .defines(function () {
    ...
    MenuAbout = Menu.extend({
      background: new ig.Image("media/background/stars2_mobile.jpg"),
...
ig.module("game.main")
  ...
  .defines(function () {
    ...
    ZType = ig.Game.extend({
      ...
      stars: new ig.Image("media/background/stars2_mobile.jpg"),
      ...
      init: function () {
        ...
        if (soundVolume !== null && musicVolume !== null) {
          ...
          ig.soundManager.volume = 0.5; //volume
          ig.music.volume = 0.3;
        }
    ...
    ZType.WAVES = {
      MOBILE: {
        ...
        speedIncrease: 1.01,
        types: [
          { type: EntityEnemyOppressor, count: 0, incEvery: 6 }, //difficulty mobile
      ...
      DESKTOP: {
        ...
        speedIncrease: 1.05,
        types: [
          { type: EntityEnemyOppressor, count: 0, incEvery: 5 }, //difficulty
          { type: EntityEnemyDestroyer, count: 0, incEvery: 2 },
          { type: EntityEnemyMine, count: 5, incEvery: 1 },
        ],
      },
    };
